...
<body class="bg-dark-slate text-gray-800 antialiased min-h-screen flex flex-col">
    ...
    <header class="bg-white shadow-sm sticky top-0 z-50">
        <div class="px-6 py-3 border-b border-gray-100 flex items-center">
            ...
            <div class="ml-auto flex items-center">
                <a href="{{ route('atasan.dashboard') }}" class="text-sm font-semibold text-gray-600 hover:text-gray-900 transition mr-4">Kembali ke Dashboard</a>
            </div>
        </div>
    </header>
    ...
    <main class="flex-grow max-w-7xl mx-auto w-full px-4 sm:px-6 lg:px-8 py-8 flex flex-col items-center">
        ...
        <!-- Main Card Block -->
        <form id="assessment-form" method="POST" action="{{ route('atasan.competency_atasan.store', $talent->id) }}">
            @csrf

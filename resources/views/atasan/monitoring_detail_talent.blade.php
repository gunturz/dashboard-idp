    ...
    <div class="page-header animate-title">
        ...
        <div>
            <div class="flex items-center gap-3">
                ...
                <span class="px-2.5 py-0.5 rounded-full bg-teal-50 text-teal-600 text-[10px] font-bold uppercase tracking-wider border border-teal-100">Monitoring Mode</span>
            </div>
        ...
        <div class="prem-card mb-8 animate-fade-in" style="animation-delay: 0.1s;">
            ...
            <div class="p-6">
                ...
                <div class="gap-pills-container">
                    ...
                    @empty
                        <div class="py-10 text-center bg-gray-50 rounded-2xl border border-dashed border-gray-100 text-gray-400">
                        ...
                        <div class="flex flex-col items-center gap-5">
                            <div class="relative w-36 h-36">
                                ...
                                <div class="absolute inset-0 flex flex-col items-center justify-center">
                                    <span class="text-2xl font-black text-[#1e293b] leading-none">{{ $chart['done'] }}/{{ $chart['total'] }}</span>
                                    <span class="text-[10px] text-gray-400 font-bold uppercase mt-1">{{ round($pct * 100) }}%</span>
                                </div>
                            </div>
                            <span class="px-5 py-1.5 bg-gray-50 border border-gray-100 rounded-full text-xs font-bold text-[#475569] shadow-sm">{{ $chart['label'] }}</span>
                        </div>
                    @endforeach
                </div>
            </div>
                                    ...
                                    <td class="project-status-cell">
                                        ...
                                        @else
                                            <span class="inline-flex items-center gap-1 text-orange-600 text-[11px] font-bold bg-orange-50 px-3 py-1 rounded-full border border-orange-100">
                                                <span class="w-1.5 h-1.5 rounded-full bg-orange-500"></span> {{ $proj->status ?: 'Pending' }}
                                            </span>
                                        @endif
                                    </td>
                                </tr>
                            @empty
                                <tr><td colspan="3" class="py-12 text-center text-gray-400 font-medium italic">Belum ada project improvement yang diupload.</td></tr>
                            @endforelse
                        </tbody>
                    </table>
                </div>
            ...
            <div class="p-8">
                <div class="flex flex-col md:flex-row items-center justify-between gap-8">
                    <div class="flex items-center gap-6">
                        <div class="w-16 h-16 rounded-2xl bg-teal-50 flex items-center justify-center text-teal-600 border border-teal-100 shadow-sm">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-500 leading-relaxed md:max-w-md">Pantau progress Exposure, Mentoring, dan Learning secara lengkap melalui dashboard logbook terintegrasi.</p>
                        </div>
                    </div>
                    <a href="{{ route('atasan.monitoring.logbook', $talent->id) }}" class="btn-prem btn-teal px-8 py-3 rounded-xl shadow-md whitespace-nowrap">

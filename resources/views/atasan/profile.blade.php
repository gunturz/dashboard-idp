<x-atasan.layout title="Profile" bodyClass="bg-gray-50 min-h-screen flex flex-col pt-[80px]" :showProfileCard="false"
    ...
    <div class="prof-page mx-auto w-full animate-title pb-8 px-6 pt-12">
        ...
        <div class="prof-hero">
            ...
            <div class="prof-hero-info">
                <div class="prof-hero-name">{{ $user->nama ?? 'Nama Atasan' }}</div>
                @php $roleName = ucwords(str_replace('_', ' ', $activeRoleName ?? $user->role->role_name ?? 'Atasan')); @endphp

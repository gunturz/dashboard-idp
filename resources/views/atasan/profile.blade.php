<x-atasan.layout title="Profile" bodyClass="bg-gray-50 min-h-screen flex flex-col pt-[80px]" :showProfileCard="false" :user="$user" :notifications="$notifications">
    <x-slot name="styles">
        <style>
            .section-header {
...
{{-- MAIN CONTENT --}}
    <div class="w-full max-w-3xl mx-auto px-6 pb-8 pt-0 flex-grow fade-up">
        ...
        {{-- Row Back --}}
        <div class="mb-5">
            <a href="{{ route('atasan.dashboard') }}" class="inline-flex items-center gap-2 text-sm font-bold text-[#EAB308] hover:text-[#CA8A04] transition-colors group">
        ...
        <div class="flex items-center gap-3 mb-6">
            ...
            <h1 class="text-2xl font-bold text-[#2e3746]">Profile Atasan</h1>
        </div>
        ...
        @if (session('status') === 'profile-updated')
            <div id="success-banner"
                ...
                <div class="flex items-center gap-2">
                    ...
                    <span class="text-sm font-semibold">Pengubahan Profile Atasan berhasil</span>
                </div>

    ...
    <form method="POST" action="{{ route('login') }}">
        ...
        <div style="margin-bottom: 1rem;">
            ...
            <div class="input-wrapper">
                ...
                <input id="username" type="text" name="username" value="{{ old('username', session('register_non_kandidat.username') ?? session('register_kandidat.username')) }}" class="form-input"

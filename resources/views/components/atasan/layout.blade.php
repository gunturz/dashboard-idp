...
<body class="bg-[#ffffff] min-h-screen pt-[80px] flex flex-col relative">
    ...
    <div class="navbar-outer">
        ...
        <div
            class="flex items-center space-x-2 sm:space-x-3 pl-0 lg:pl-4 border-l-0 lg:border-l border-white/20 lg:ml-0 ml-auto">
    ...
    {{-- FOOTER --}}
    <footer
        class="mt-auto bg-gradient-to-br from-[#2e3746] to-[#1e293b] py-6 text-center w-full border-t border-white/5">

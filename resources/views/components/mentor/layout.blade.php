...
<body class="bg-[#f8fafc] min-h-screen pt-[80px]">

    <div class="navbar-outer">
        <a href="{{ route('mentor.dashboard') }}" class="flex items-center gap-4 flex-shrink-0 hover:opacity-90 transition-opacity">
        ...
        <div class="flex items-center ml-auto h-full gap-2 mr-6">
        ...
        <div class="flex items-center space-x-3 pr-6 border-l border-white/20 pl-6 h-10">
            {{-- Notification --}}
    ...
    {{-- MAIN CONTENT --}}
    <main class="p-8 max-w-6xl mx-auto w-full pt-12">
        {{ $slot }}
    </main>

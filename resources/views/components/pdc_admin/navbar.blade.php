    ...
    <div class="flex items-center space-x-3 ml-auto lg:pr-6 pr-0">
        ...
        <div class="relative" id="bell-wrapper">
            ...
            <div id="bell-dropdown"
                class="dropdown-panel hidden absolute right-0 mt-3 w-[320px] bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden z-50">
                ...
                <div class="px-5 py-3.5 bg-white border-t border-gray-100 text-center">
                    <a href="{{ route('pdc_admin.notifikasi') }}" class="text-[13px] font-bold text-gray-400 hover:text-gray-600 transition-colors">Lihat semua notifikasi</a>
                </div>
            </div>
        </div>

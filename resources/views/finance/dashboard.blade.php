    ...
    <div class="mb-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
            <div class="bg-white rounded-xl border-2 border-teal-500 p-6 flex flex-col items-center justify-center shadow-sm hover:shadow-md transition-shadow">
                <span class="text-4xl font-extrabold text-teal-500 mb-2">4</span>
            ...
            <div class="bg-white rounded-xl border-2 border-yellow-400 p-6 flex flex-col items-center justify-center shadow-sm hover:shadow-md transition-shadow">
                <span class="text-4xl font-extrabold text-yellow-400 mb-2">2</span>
            ...
            <div class="bg-white rounded-xl border-2 border-green-500 p-6 flex flex-col items-center justify-center shadow-sm hover:shadow-md transition-shadow">
                <span class="text-4xl font-extrabold text-green-500 mb-2">1</span>
            ...
            <div class="bg-white rounded-xl border-2 border-red-500 p-6 flex flex-col items-center justify-center shadow-sm hover:shadow-md transition-shadow">
                <span class="text-4xl font-extrabold text-red-500 mb-2">1</span>
            ...
            <div class="w-full sm:w-1/2 lg:w-1/4">
                <div class="relative">
                    <select class="w-full px-4 py-2.5 rounded-lg border border-teal-500 focus:outline-none focus:ring-1 focus:ring-teal-500 text-sm text-gray-600 appearance-none bg-white">
                        ...
                        <option>Officer - Finance</option>
                        <option>Officer - Human Resource</option>
                    </select>
        ...
        <div class="bg-white border text-sm border-gray-200 rounded-lg p-4 flex flex-col sm:flex-row items-center justify-between shadow-sm mb-8">
            <p class="text-gray-700 font-medium mb-3 sm:mb-0">
                Ada <span class="font-bold">2 Permintaan</span> yang menunggu validasi anda
            </p>
        ...
        <div class="mb-8 overflow-hidden bg-white border border-gray-300 rounded-xl shadow-sm">
            <div class="bg-gray-50 border-b border-gray-300 px-6 py-4 text-center">
                <h3 class="text-gray-800 font-bold text-lg">Manager</h3>
            </div>
            <div class="overflow-x-auto">
                <table class="w-full text-left border-collapse">
                    <thead>
                        <tr class="border-b border-gray-300">
                            <th class="px-6 py-4 text-sm font-bold text-gray-700 text-center w-1/4 break-words">Talent</th>
                            <th class="px-6 py-4 text-sm font-bold text-gray-700 text-center border-l w-1/4 break-words border-gray-300">Project</th>
                            <th class="px-6 py-4 text-sm font-bold text-gray-700 text-center border-l w-1/4 break-words border-gray-300">Feedback</th>
                            <th class="px-6 py-4 text-sm font-bold text-gray-700 text-center border-l w-1/4 break-words border-gray-300">Status</th>
                        </tr>
                    </thead>
                    <tbody class="text-sm">
                        <tr class="border-b border-gray-300 hover:bg-gray-50 transition-colors">
                            <td class="px-6 py-4 border-r border-gray-300">
                                <p class="font-bold text-gray-800 text-sm">Arif</p>
                                <p class="text-xs text-gray-500 italic mt-1">Officer - Finance</p>
                            </td>
                        ...
                        <tr class="hover:bg-gray-50 transition-colors">
                            <td class="px-6 py-4 border-r border-gray-300">
                                <p class="font-bold text-gray-800 text-sm">Bambang</p>
                                <p class="text-xs text-gray-500 italic mt-1">Officer - Finance</p>
                            </td>
                            <td class="px-6 py-4 font-bold text-gray-800 text-center border-r border-gray-300">
                                Judul Project
        ...
        {{-- Officer Table Section --}}
        <div class="mb-8 overflow-hidden bg-white border border-gray-300 rounded-xl shadow-sm">
            <div class="bg-gray-50 border-b border-gray-300 px-6 py-4 text-center">
                <h3 class="text-gray-800 font-bold text-lg">Officer</h3>
            </div>
            <div class="overflow-x-auto">
                <table class="w-full text-left border-collapse">
                    <thead>
                    ...
                    <tbody class="text-sm">
                        <tr class="border-b border-gray-300 hover:bg-gray-50 transition-colors">
                            <td class="px-6 py-4 border-r border-gray-300">
                                <p class="font-bold text-gray-800 text-sm">Rika</p>
                                <p class="text-xs text-gray-500 italic mt-1">Staff - Human Resource</p>
                            </td>
                            <td class="px-6 py-4 font-bold text-gray-800 text-center border-r border-gray-300">
                                Judul Project
                            </td>
                            <td class="px-6 py-4 text-gray-700 font-medium text-center border-r border-gray-300">
                                Baik
                            </td>
                        ...
                        <tr class="hover:bg-gray-50 transition-colors">
                            <td class="px-6 py-4 border-r border-gray-300">
                                <p class="font-bold text-gray-800 text-sm">Baki</p>
                                <p class="text-xs text-gray-500 italic mt-1">Staff - Human Resource</p>
                            </td>
                            <td class="px-6 py-4 font-bold text-gray-800 text-center border-r border-gray-300">
                                Judul Project

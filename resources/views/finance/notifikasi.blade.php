<x-finance.layout title="Notifikasi – Finance Individual Development Plan" :user="$user" :notifications="$notifications">
    <x-slot name="styles">
        <style>
            .notif-card {
    ...
    <div class="w-full max-w-4xl mx-auto">
        ...
        <div class="flex items-center justify-between mb-6">
            ...
            <form action="{{ route('finance.notifikasi.markAllRead') }}" method="POST">
                @csrf
                    ...
                    <div class="flex-1">
                        <div class="flex justify-between items-start mb-1">
                            ...
                            @if (!empty($notif['badge']))
                                <span class="text-xs text-teal-600 font-semibold bg-teal-50 px-2 py-1 rounded-md">
                                    {{ $notif['badge'] }}
                                </span>
                            @endif
                        </div>

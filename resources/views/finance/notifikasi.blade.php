<x-finance.layout :user="auth()->user()" :notifications="collect(\App\Models\AppNotification::where('user_id', auth()->id())->get())">
    ...
    <x-slot name="styles">
        <style>
            ...
            .page-header-actions { margin-left: auto; display: flex; align-items: center; gap: 8px; flex-shrink: 0; }
        </style>
    </x-slot>

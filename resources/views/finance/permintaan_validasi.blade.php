        ...
        <div class="space-y-6">
            ...
            <div class="prem-card">
                ...
                <div class="prem-card-header cursor-pointer select-none hover:bg-gray-50 transition-colors" onclick="toggleAccordion('content-{{ $project->id }}', 'icon-{{ $project->id }}')">
                    ...
                    <div class="flex items-center justify-between md:justify-end gap-6 w-full md:w-[25%] mt-2 md:mt-0">
                        ...
                        <svg id="icon-{{ $project->id }}" xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-teal-600 transition-transform duration-300 {{ $index === 0 ? 'transform rotate-180' : '' }}" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <div id="content-{{ $project->id }}" class="px-6 border-t border-gray-100 bg-white transition-all overflow-hidden {{ $index === 0 ? 'pb-6 pt-5 max-h-[1000px] opacity-100' : 'pb-0 pt-0 max-h-0 opacity-0' }}">
            ...
            <div class="prem-card">
                <div class="empty-prem">
                    ...
                    <p>Semua permintaan validasi telah Anda proses.</p>
                </div>
            </div>
            @endforelse

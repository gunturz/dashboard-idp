    ...
    <div id="finance-confirm-modal"
        ...
        <div class="bg-white rounded-[28px] shadow-2xl w-full max-w-[400px] p-8 text-center transform scale-90 transition-transform duration-400 ease-out border border-slate-100"
            ...
            <p class="text-[14px] text-slate-500 leading-relaxed mb-8 font-medium">
                Apakah Anda yakin ingin <span id="modalActionText" class="font-black text-slate-900">...</span> project <span id="modalProjectTitle" class="font-black text-slate-900">...</span> dari <span id="modalTalentName" class="font-black text-slate-900">...</span>?
                <br><span class="text-slate-400 text-[12px] italic mt-2 block">Keputusan ini akan dikirim ke PDC Admin untuk persetujuan akhir.</span>
            </p>
    ...
    <script>
        ...
        function showConfirmModal(event, formId, decision, talentName, projectTitle) {
            ...
            if (decision === 'Approved') {
                ...
                submitBtn.className = 'w-full bg-[#14b8a6] text-white font-black py-3.5 rounded-2xl hover:bg-teal-600 hover:shadow-lg hover:shadow-teal-500/30 transition-all duration-200';
            } else {
                actionText.textContent = 'Reject';
                actionText.className = 'font-black text-slate-900';
                submitBtn.className = 'w-full bg-red-500 text-white font-black py-3.5 rounded-2xl hover:bg-red-600 hover:shadow-lg hover:shadow-red-500/30 transition-all duration-200';
            }

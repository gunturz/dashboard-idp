<x-finance.layout title="Profile" :user="$user">
    <x-slot name="styles">
        <style>
            /* ══ Profile Page ══ */
    ...
    <div class="prof-page mx-auto w-full animate-title pb-8 px-6">
        ...
        <div class="prof-hero">
            ...
            <div class="prof-hero-info">
                <div class="prof-hero-name">{{ $user->nama ?? 'Nama Finance' }}</div>
                @php $roleName = ucwords(str_replace('_', ' ', $activeRoleName ?? $user->role->role_name ?? 'Finance')); @endphp

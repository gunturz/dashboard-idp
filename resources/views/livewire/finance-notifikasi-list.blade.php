...
<div wire:poll.10s="loadNotifications">
    ...
    <div class="w-full flex justify-start mb-8">
        <a href="{{ route('finance.dashboard') }}" class="btn-prem btn-ghost" style="display: flex; align-items: center; gap: 8px; font-weight: 600; color: #475569; padding: 10px 16px; border-radius: 8px; background: #fff; border: 1px solid #e2e8f0; transition: all 0.2s;">

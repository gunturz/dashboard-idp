<div>
    ...
    <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-6">
        <div class="relative w-full sm:w-80">
            ...
            <input type="text" wire:model.live.debounce.300ms="search" placeholder="Cari nama perusahaan.."
    ...
    <div class="prem-card p-4 sm:p-8 w-full mb-10">
        ...
        <div wire:loading class="text-center py-6">
            <svg class="animate-spin h-5 w-5 text-[#0f172a] mx-auto" xmlns="http://www.w3.org/2000/svg" fill="none"
                viewBox="0 0 24 24">
                ...
                <div class="company-row company-item">
                    ...
                    <div class="flex items-center gap-2 company-actions">
                        ...
                        <button type="button"
                            ...
                            class="flex items-center justify-center w-10 h-10 bg-blue-500 hover:bg-blue-600 border border-blue-600 hover:border-blue-700 rounded-xl transition-colors shadow-sm">

<x-mentor.layout title="Profile" bodyClass="bg-gray-50 min-h-screen flex flex-col pt-[80px]" :showProfileCard="false" :user="$user" :notifications="$notifications">
    <x-slot name="styles">
        <style>
            .section-header {
...
{{-- MAIN CONTENT --}}
    <div class="w-full max-w-3xl mx-auto px-6 pb-8 pt-0 flex-grow fade-up">
        ...
        <div class="flex items-center gap-3 mb-6">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-7 w-7 text-[#0f172a]" viewBox="0 0 20 20" fill="currentColor">
                <path fill-rule="evenodd" d="M10 9a3 3 0 100-6 3 3 0 000 6zm-7 9a7 7 0 1114 0H3z" clip-rule="evenodd"/>
            </svg>
            <h1 class="text-2xl font-bold text-[#0f172a]">Profile Mentor</h1>
        </div>
        ...
        @if (session('status') === 'profile-updated')
            <div id="success-banner"
                ...
                <div class="flex items-center gap-2">
                    ...
                    <span class="text-sm font-semibold">Pengubahan Profile Mentor berhasil</span>
                </div>

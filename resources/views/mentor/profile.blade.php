<x-mentor.layout title="Profile" bodyClass="bg-gray-50 min-h-screen flex flex-col pt-[80px]" :showProfileCard="false"
    ...
    <div class="prof-page mx-auto w-full pb-8 px-6">
        ...
        <div class="prof-hero">
            ...
            <div class="prof-hero-info">
                <div class="prof-hero-name">{{ $user->nama ?? 'Nama Mentor' }}</div>
                @php $roleName = ucwords(str_replace('_', ' ', $activeRoleName ?? $user->role->role_name ?? 'Mentor')); @endphp

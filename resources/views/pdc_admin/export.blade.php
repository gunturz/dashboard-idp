<x-pdc_admin.layout title="Export – PDC Admin" :user="$user">
    ...
    <div class="export-filters">
        <div class="filter-search">
            <input type="text" id="searchTalent" class="filter-input" placeholder="Cari Nama Talent"
                onkeyup="filterExport()">
        </div>
        <div class="filter-select">
            <select id="filterJabatan" class="filter-select-el" onchange="filterExport()">
        ...
        <div class="filter-select">
            <select id="filterPerusahaan" class="filter-select-el" onchange="filterExport()">

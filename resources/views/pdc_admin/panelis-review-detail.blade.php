<x-pdc_admin.layout title="Lihat Penilaian Panelis – Individual Development Plan" :user="$user" :hideSidebar="true">
    ...
    <div class="flex justify-end gap-3">
        ...
        @php
            $isComplete = in_array(optional($talent->promotion_plan)->status_promotion, [
                'Approved Panelis',
                'Rejected Panelis',
            ]);
        @endphp
        ...
        @else
            <form method="POST" action="{{ route('pdc_admin.panelis_review.complete', $talent->id) }}"
                id="form-selesai-panelis">
                @csrf

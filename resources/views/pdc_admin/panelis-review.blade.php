<x-pdc_admin.layout title="Panelis Review – Individual Development Plan" :user="$user">
    ...
    {{-- ── Success Message ── --}}
    @if (session('success'))
        <div id="success-alert" class="flex items-center gap-3 mb-5 bg-emerald-50 border border-emerald-200 text-emerald-700 px-4 py-3 rounded-xl text-sm font-medium transition-all duration-500">

<x-talent.layout title="Notifikasi – Individual Development Plan" bodyClass="bg-gray-50 min-h-screen flex flex-col pt-[80px]" :showProfileCard="false" :user="$user" :notifications="$notifications">
    <x-slot name="styles">
        <style>
    ...
    <div class="w-full max-w-4xl mx-auto px-6 pt-8 pb-12 flex-grow fade-up fade-up-1">
        ...
        <div class="flex items-center justify-between mb-6">
            <div class="page-header animate-title mb-0">
                ...
                <div>
                    ...
                    <div class="page-header-sub">Informasi terbaru mengenai status program IDP Anda</div>
                </div>
            </div>

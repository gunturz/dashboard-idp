            ...
            <div class="prof-section">
                ...
                @php
                    $profilFields = [
                        ...
                        ['label'=>'Mentor',               'key'=>'mentor',        'type'=>'readonly', 'val'=>collect(optional($user->promotion_plan)->mentor_models)->pluck('nama')->join(', ') ?: (optional($user->mentor)->nama ?? '—')],
                        ['label'=>'Atasan',               'key'=>'atasan',        'type'=>'readonly', 'val'=>optional($user->atasan)->nama ?? '—'],
                        ['label'=>'Posisi Yang Dituju',   'key'=>'target_position','type'=>'readonly', 'val'=>optional(optional($user->promotion_plan)->targetPosition)->position_name ?? '—'],
                    ];
                @endphp
                ...
                <div class="prof-field-row">
                    ...
                    <div class="edit-field hidden flex-1 relative">
                        <input type="password" name="password" placeholder="Password baru (kosongkan jika tidak diubah)"
                               class="prof-input w-full" autocomplete="new-password">
                    </div>
                </div>
                <div class="prof-field-row">

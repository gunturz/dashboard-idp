<x-talent.layout title="Riwayat Program IDP" :user="$user" :notifications="$notifications" :mobileCollapsible="true">
    <x-slot name="styles">
        <style>
            /* Scrollbar */
            ...
            <tbody>
                @forelse($exposureActivities as $act)
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('talent.logbook.item', $act->id) }}" class="text-xs font-bold text-slate-600 flex items-center justify-center gap-1.5 hover:text-[#14b8a6] transition-colors">
    ...
    <div class="flex justify-end items-center mt-8 mb-4" id="bottom-navigation-container">
        <a href="{{ route('talent.dashboard') }}#Riwayat" class="btn-back-bottom shadow-sm" style="padding-left: 2rem; padding-right: 2rem;">
            Kembali
        </a>
    </div>
